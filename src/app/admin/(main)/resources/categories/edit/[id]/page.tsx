...
import { fetchDetailCategory, fetchEditCategory } from "@/store/thunks/admin/resourcesThunk";
...
const EditAdmin = ({ params }: { params: PageParams}) => {
  ...
  const {loading, success, categoryDetail, pageErrors} = useSelector((state: RootState) => state.page);
