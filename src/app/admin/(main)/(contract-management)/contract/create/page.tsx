...
import { fetchAllTypeList, fetchCreateContract } from "@/store/thunks/admin/contractThunk";
...
const CreateContract = () => {
  ...
  const {loading, contractErrors, success} = useSelector((state: RootState) => state.contract);
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      dispatch(fetchCreateContract(formData));
    },
