'use client';
import UserContractMainComponent from "@/components/user/contracts/Main";
import UserFormMainComponent from "@/components/user/forms/Main";
import UserResourceMainComponent from "@/components/user/resources/Main";
  ...
  return (
    <div style={{ width: "100%" }}>
      <Box className="subtitle-container">
        <Typography variant="h6" sx={{ pt: 3, mx: {xs: 2, md: 10}, mb: 5}}>Resources</Typography>
      </Box>
      <Box sx={{ mt: 4, mx: {xs: 2, md: 10}, mb: 8, position: 'relative'}}>
        <Box className="tab-container">
          <ListItemButton sx={{ p: 0 }} className='active' onClick={() => resources()}>
          ...
          <ListItemButton sx={{ p: 0 }} onClick={() => forms()}>
            <Box className="tab-item">
              <Image
                src="/images/form.png"
                width={80}
