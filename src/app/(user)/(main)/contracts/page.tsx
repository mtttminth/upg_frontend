  ...
  return (
    <div style={{ width: "100%" }}>
      <Box className="subtitle-container">
        <Typography variant="h6" sx={{ pt: 3, mx: {xs: 2, md: 10}, mb: 5}}>Contracts</Typography>
      </Box>
      <Box sx={{ mt: 4, mx: {xs: 2, md: 10}, mb: 8, position: 'relative'}}>
        <Box className="tab-container">
          ...
          <ListItemButton sx={{ p: 0 }} className='active' onClick={() => contracts()}>
            <Box className="tab-item">
              <Image
