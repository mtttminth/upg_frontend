...
import { resetPageFile, updatePageFile } from '@/store/slices/admin/mediaSlice';

registerPlugin(FilePondPluginImageExifOrientation, FilePondPluginImagePreview);

const PageFileUploader = () => {
  ...
  const handleUpdateFiles = (fileItems: any[]) => {
    dispatch(updatePageFile(fileItems));
  };
...
export default PageFileUploader;
